...
/* harmony export */   "barberian": () => (/* binding */ barberian)
/* harmony export */ });
var barberian = function barberian(sword) {
  document.querySelector('#root').addEventListener('click', function (e) {
    return console.log('Жмурика я самый слабый');
  });
  var firstDiv = document.querySelector('#root');
  sword.map(function (item) {
    if (item) {
...
var getClasses = function getClasses() {
  ...
  (0,_barbarian__WEBPACK_IMPORTED_MODULE_1__.barberian)([1, 2, 3]);
};
...
var abominationHookRecipe = _objectSpread(_objectSpread({}, orcSwordRecipe), {}, {
  alianceHelmet: 1,
  greenEmerald: 1
});
